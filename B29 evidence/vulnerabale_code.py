"""
The vulnerablilty of CVE-2026-5463 is improper neutralization of special elements leading to command injection

Referencing Github repo: https://github.com/DanMcInerney/pymetasploit3.git

The original file name : pymsfconsole.py

The file path: pymetasploit3/scripts/pymsfconsole.py

The following is the vulnerable code for easy references
"""
